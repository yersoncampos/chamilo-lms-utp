...
function get_number_of_courses() {
    ...
    $sql.= " INNER JOIN $tbl_course_rel_user course_rel_user ON (code=course_rel_user.course_code)";
    ...
    $sql.= " AND course_rel_user.user_id=".api_get_user_id();
    $sql.= " AND course_rel_user.relation_type = ".COURSE_RELATION_TYPE_COURSE_ADMIN;
